...
const connectUrl = 'wss://sd16c66d.ala.us-east-1.emqxsl.com:8084/mqtt';
topic_raiz = "Restfamarpe";
...
const options = {
  clean: true,
  connectTimeout: 4000,
  clientId: "WEB RES-FAMARPE--->> " + Math.floor(Math.random() * 1000000 + 1),
  username: 'majamesua',
  password: 'restaurantefamarpe2025%',
};
...
function tiempo_exit() {
  setTimeout(() => {
    ...
    if (entrar_pagina == "true" || entrarPagina == "true") {
     ...
     window.location = "https://maykesoluciones.github.io/pagina/Restfamarpe/html/signin.html";
    }
  }, 2000);
}
