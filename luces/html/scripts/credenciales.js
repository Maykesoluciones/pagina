...
var ably = new Ably.Realtime(username+':'+password);
  ...
  if (topic == topic_raiz){
    ...
    if(mensaje_estado == "LLene los dos campos" || mensaje_estado == "LLene el campo de usuario" || mensaje_estado == "LLene el campo de clave" || mensaje_estado == "No autorizado" ){
      document.getElementById("display_autorizacion").innerHTML = mensaje_estado;
