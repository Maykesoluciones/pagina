...
version = "2";//1,2
username = "jg4T3w.teoGPA";
password = "a0QgD23R4O9xiqP32BPk5rhbvMdKsm2vi25HH-ms1O0";
topic_raiz = "Kelly";
...
var conexion_github =
  ...
  "channels=" +
  topic_raiz +
  topic_github_actualizacion_recibe +
  "&v=" +
  version +
  "&key=" +
  username +
...
function tiempo_exit() {
  setTimeout(() => {
    ...
    window.location = "https://maykesoluciones.github.io/pagina/Kelly/html/signin.html";
    }
  }, 2000);
}
